...
<body>
  <div class="container mt-5">
    ...
    <?php include('registerusers_v.php'); ?>
    ...
    <form action="" method="post" novalidate>
      ...
      <div class="form-group row" >
        ...
        <div class="col-sm-8">
          <input type="dateofbirth" name="dateofbirth" class="form-control" value="<?php echo $dateofbirth; ?>">

          <!-- Error -->
          <?php echo $dateofbirthEmptyErr; ?>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <textarea class="form-control" name="comment" id="comment" rows="4"><?php echo $comment; ?></textarea>
